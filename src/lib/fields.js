...
export const fields={
  ...
  petinggi:[field('name','Nama'),field('jabatan','Jabatan'),field('angkatan','Angkatan')],
  divisi:[field('nama','Nama Divisi'),field('kepanjangan','Nama Lengkap Divisi'),field('kepala','Kepala Divisi'),field('anggota','Jumlah Anggota','number'),field('color','Warna','color',['bg-[#c9970d]','bg-indigo-500','bg-violet-500','bg-pink-500','bg-amber-500','bg-teal-500','bg-green-500','bg-orange-500'])],
